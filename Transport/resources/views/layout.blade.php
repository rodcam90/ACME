        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('/propietarios')}}" class="nav-link active">
              ...
              <p>
                Propietarios 
                <i class="right fas fa-angle-left"> {{Propietario::all()->count()}}  </i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/propietarios/create')}}" class="nav-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            <a href="{{ url('/conductores') }}" class="nav-link active">
              ...
              <p>
                Conductores
                <i class="right fas fa-angle-left"> {{ Conductor::all()->count() }}</i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('/vehiculos')}}" class="nav-link active">
              ...
              <p>
                Vehiculos
                <i class="right fas fa-angle-left"> {{ Vehiculo::all()->count() }} </i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
